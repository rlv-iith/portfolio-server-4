...
export default function Researcher() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-emerald-500/30 relative overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 w-full h-16 bg-black/60 backdrop-blur-md border-b border-white/10 flex items-center justify-between px-6 z-50">
        <div className="flex items-center gap-4">
            ...
            <div className="text-sm font-mono text-gray-500">
                SYSTEM :: <span className={data.color}>RESEARCHER</span> VIEW
            </div>
        </div>
            ...
            {projects.map((project) => (
                ...
                >
                    <div className="p-8">
                        ...
                        {/* Title */}
                        <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-emerald-200 transition-colors brand-font">
                            {project.title}
                        </h3>
